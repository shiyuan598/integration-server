...
class App_process(db.Model):
    ...
    lidar = Column(String(100), nullable=False, comment="激光模型")
    camera = Column(String(100), nullable=False, comment="视觉模型")
    map = Column(String(100), nullable=False, comment="地图数据")
